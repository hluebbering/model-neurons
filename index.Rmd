...
$$
\begin{align}
\int^t_{-\infty} \alpha (t-t^\prime) [c_1E (t^\prime) - c_2I (t^\prime) + P(t^\prime)] dt^\prime
\end{align} \tag{7}
$$
...
&\qquad \qquad {\Large{\bf \cdotp}} \mathcal{S}_e(x) \left\{1-\gamma \left[{\int^t_{t-r}E(t^\prime) \; dt^\prime,
\mathcal{S}_e(x)}\right] \right \} \delta t
\end{align}
\tag{9}
$$
